...
-- FK from course_activities → practice_library (для «Обновить в Листе»).
-- ALTER для существующих схем — в migration v27; для новых установок
-- ниже добавляем колонку через ALTER после создания course_activities.
